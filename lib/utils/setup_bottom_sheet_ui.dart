...
import 'package:hackathon_study_materials/ui/widgets/input_bottom_sheet.dart';
...
void setupBottomSheetUi() {
  ...
  final builders = {
    ...
    BottomSheetType.input: (context, sheetRequest, completer) =>
        InputBottomSheet(request: sheetRequest, completer: completer),
  };
